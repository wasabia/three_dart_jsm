...
class WebGPURenderPipeline {
  ...
  //     var stepMode = (geometryAttribute != undefined && geometryAttribute is InstancedBufferAttribute)
  ...
  //       module: stageVertex.stage["module"], entryPoint: stageVertex.stage["entryPoint"], buffers: vertexBuffers);
  ...
  //   var pipelineLayout = this
  //       ._device
  //       .createPipelineLayout(GPUPipelineLayoutDescriptor(bindGroupLayouts: bindGroupLayout, bindGroupLayoutCount: 1));
  ...
  //         : GPUIndexFormat.Uint16; // define data type for primitive restart value
  ...
  //     attributes.add({"name": name, "arrayStride": arrayStride, "format": format, "slot": slot});
  //   }
