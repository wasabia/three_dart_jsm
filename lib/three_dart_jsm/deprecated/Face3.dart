...
class Face3 {
  ...
  late int materialIndex;
	...
	Face3( a, b, c, normal, color, {int materialIndex = 0} ) {
		...
		this.normal = ( normal != null && normal.runtimeType == THREE.Vector3 ) ? normal : new THREE.Vector3.init();
		this.vertexNormals = normal != null ? normal : [];

		this.color = ( color != null && color.runtimeType == THREE.Color ) ? color : new THREE.Color(0,0,0);
