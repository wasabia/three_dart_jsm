		...
		for ( var i = 0; i < faces.length; i ++ ) {
			...
			if ( hasFaceVertexUv == true ) {
				...
				if ( vertexUvs != null ) {
					...
					this.uvs.addAll( [new THREE.Vector2(null, null), new THREE.Vector2(null, null), new THREE.Vector2(null, null)] );
			...
			if ( hasFaceVertexUv2 == true ) {
				...
				if ( vertexUvs != null ) {
					...
					this.uvs2.addAll( [new THREE.Vector2(null,null), new THREE.Vector2(null,null), new THREE.Vector2(null,null)] );
