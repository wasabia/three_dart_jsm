...
class VertexTangentsHelper extends LineSegments {
  ...
  VertexTangentsHelper.create(geometry, material) : super(geometry, material) {
	...
	factory VertexTangentsHelper( object, [size = 1, color = 0x00ffff] ) {
		...
		var positions = new Float32BufferAttribute( Float32Array(nTangents * 2 * 3), 3 );

		geometry.setAttribute( 'position', positions );

		var vth = VertexTangentsHelper.create( geometry, new LineBasicMaterial( { "color": color, "toneMapped": false } ) );
