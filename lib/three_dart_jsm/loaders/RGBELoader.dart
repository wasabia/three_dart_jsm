		...
		const
			...
			var rgbe_error = ( rgbe_error_code, msg ) {
				...
				switch ( rgbe_error_code ) {
					...
					case rgbe_read_error: print( 'THREE.RGBELoader Read Error: ${msg ?? ""}');
						break;
					case rgbe_write_error: print( 'THREE.RGBELoader Write Error: ${msg ?? ""}' );
						break;
					case rgbe_format_error: print( 'THREE.RGBELoader Bad File Format: ${msg ?? ""}' );
						break;
					case rgbe_memory_error: print( 'THREE.RGBELoader: Error: ${msg ?? ""}' );
            break;
          default:
