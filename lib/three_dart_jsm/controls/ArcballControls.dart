...
class ArcballControls with EventDispatcher {
  ...
  var _switchSensibility = 32;	//minimum movement to be performed to fire single pan start after the second finger has been released
  ...
  var _cursorPosPrev = new Vector3();	//cursor position when previous rotate operation has been detected
  var _cursorPosCurr = new Vector3();//cursor position when current rotate operation has been detected
		...
		if ( this.enabled ) {
			...
			switch ( operation ) {
				...
				case 'ROTATE':
					...
					this._startCursorPosition.copy( this.unprojectOnTbSurface( this.camera, _center.x, _center.y, this.listenableKey, this._tbRadius ) );
				...
				case STATE2.ROTATE:
					...
					if ( this.enableRotate ) {
						...
						if ( restart ) {
							...
							this._currentCursorPosition.copy( this.unprojectOnTbSurface( this.camera, _center.x, _center.y, this.listenableKey, this._tbRadius ) );
