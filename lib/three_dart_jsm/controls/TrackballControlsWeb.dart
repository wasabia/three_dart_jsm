...
class TrackballControlsPlatform with TrackballControls, EventDispatcher {
  ...
  var _zoomStart = new Vector2(null, null), _zoomEnd = new Vector2(null, null);

  num _touchZoomDistanceStart = 0;
  num _touchZoomDistanceEnd = 0;

  var _panStart = new Vector2(null, null), _panEnd = new Vector2(null, null);
  ...
  getMouseOnScreen(pageX, pageY) {
    _vectorGetMouseOnScreen.set((pageX - this.screen.left) / this.screen.width,
  ...
  panCamera() {
    ...
    if (mouseChange.lengthSq() != 0) {
      if (this.object.isOrthographicCamera) {
        var scale_x = (this.object.right - this.object.left) /
            this.object.zoom /
            this.domElement.clientWidth;
        var scale_y = (this.object.top - this.object.bottom) /
            this.object.zoom /
            this.domElement.clientWidth;
    ...
    if (!this.noZoom || !this.noPan) {
      if (_eye.lengthSq() > this.maxDistance * this.maxDistance) {
        this
            .object
            .position
            .addVectors(this.target, _eye.setLength(this.maxDistance));
        _zoomStart.copy(_zoomEnd);
      }
      ...
      if (_eye.lengthSq() < this.minDistance * this.minDistance) {
        this
            .object
            .position
            .addVectors(this.target, _eye.setLength(this.minDistance));
        _zoomStart.copy(_zoomEnd);
      }
    }
  }
  ...
  dispose() {
    ...
    this
        .domElement
        .ownerDocument
        .removeEventListener('pointerup', onPointerUp, false);
